...
*/
  ...
  inv[4].ii = 4 * 16 + 1; inv[4].i1 =  1; inv[4].i2 = 1; inv[4].i3 = 0; inv[4].i4 = 0b00110000; //ring[1]
//  inv[5].ii = 6 * 16 + findItem(4,1); inv[5].i1 =  5; inv[5].i2 = 0; inv[5].i3 = 0; inv[5].i4 = 0b10000000;
